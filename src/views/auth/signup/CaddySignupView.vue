  ...
  <div class="caddy-signup">
    ...
    <template v-else>
      ...
      <form class="caddy-signup__form" @submit.prevent="handleSubmit">
        ...
        <!-- 소속 골프장 선택 -->
        <div class="caddy-signup__field">
          <label class="caddy-signup__label">소속 골프장</label>
          <select
            v-model="form.golfCourseId"
            class="caddy-signup__select"
          ...
          <p v-if="errors.golfCourseId" class="caddy-signup__field-error">{{ errors.golfCourseId }}</p>
          <p v-else-if="coursesError" class="caddy-signup__hint">{{ coursesError }}</p>
        </div>
...
.caddy-signup__select:focus { border-color: var(--caddy-primary); }
.caddy-signup__select.is-error { border-color: var(--color-danger); }

.caddy-signup__field-error {
  font-size: var(--font-size-detail);
